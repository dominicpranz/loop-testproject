...
var snowStorm = (function (g, f) {
	...
	q = (function () {
		...
		var e,
			b = g.requestAnimationFrame || g.webkitRequestAnimationFrame || g.mozRequestAnimationFrame || g.oRequestAnimationFrame || g.msRequestAnimationFrame || c;
		e = b
			? function () {
		...
		e = {
			transform: { ie: d("-ms-transform"), moz: d("MozTransform"), opera: d("OTransform"), webkit: d("webkitTransform"), w3: d("transform"), prop: null },
			getAnimationFrame: e,
		};
	...
	this.setXY = function (c, d, e) {
		...
		a.usePixelPosition || w
			? ((c.style.left = d - a.flakeWidth + "px"), (c.style.top = e - a.flakeHeight + "px"))
			: r
	...
	this.events = (function () {
		...
		var e = !g.addEventListener && g.attachEvent,
			...
			f = { add: e ? "attachEvent" : "addEventListener", remove: e ? "detachEvent" : "removeEventListener" };
		return {
			add: function () {
				d(a(arguments), "add");
			},
	...
	this.resizeHandler = function () {
		g.innerWidth || g.innerHeight
			? ((h = g.innerWidth - 16 - a.flakeRightOffset), (l = a.flakeBottom || g.innerHeight))
	...
	this.SnowFlake = function (c, d, e) {
		...
		this.stick = function () {
			r || (a.targetElement !== f.documentElement && a.targetElement !== f.body)
				...
				: ((b.o.style.display = "none"), (b.o.style.bottom = "0%"), (b.o.style.position = "fixed"), (b.o.style.display = "block"));
		};
